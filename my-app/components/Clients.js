...
const Clients = () => {
  return (
    <div className=" text-2xl pl-10 pr-10">
        ...
        <div className='pt-10'>
        <div className='flex p-5 justify-center pt-5'>
            <Image src={"/clients/edutest.png"} width={200} height={200} alt='' className='p-10'/>
            <Image src={"/clients/NTA.png"} width={300} height={200} alt='' className='p-10'/>
            <Image src={"/clients/asquare.webp"} width={200} height={50} alt='' className='p-10'/>
        </div>
